...
| 8 | `08_devolucion_rubrica.md` | Mejorar el puntaje según la devolución literal del agente evaluador (D1-D5) | Este mismo ciclo de cambios: `prompts/`, prueba de "cero IA en runtime", análisis económico reproducible, evidencia de ejecución, gobernanza más precisa |
